...
CREATE TABLE "FuncionarioLotacao" (
    ...
    CONSTRAINT "FuncionarioLotacao_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "OrganizacaoSetor" (
    ...
    CONSTRAINT "OrganizacaoSetor_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "OrganizacaoCargo" (
    ...
    CONSTRAINT "OrganizacaoCargo_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "OrganogramaPosicao" (
    ...
    CONSTRAINT "OrganogramaPosicao_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "OrganogramaVinculo" (
    ...
    CONSTRAINT "OrganogramaVinculo_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "FuncionarioPosicao" (
    ...
    CONSTRAINT "FuncionarioPosicao_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "EmpresaRepresentante" (
    ...
    CONSTRAINT "EmpresaRepresentante_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "EmpresaEncarregadoSistema" (
    ...
    "dataSolicitacaoSaida" TIMESTAMP(3),
    "motivoSolicitacaoSaida" TEXT,

    CONSTRAINT "EmpresaEncarregadoSistema_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "UsuarioAbrangencia" (
    ...
    CONSTRAINT "UsuarioAbrangencia_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "BackupPoliticaTenant" (
    ...
    "configuradoEm" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "BackupPoliticaTenant_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "BackupExecucaoTenant" (
    ...
    CONSTRAINT "BackupExecucaoTenant_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "BackupRestauracaoTenant" (
    ...
    CONSTRAINT "BackupRestauracaoTenant_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "DashboardLayoutUsuario" (
    ...
    CONSTRAINT "DashboardLayoutUsuario_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "DashboardWidgetUsuario" (
    ...
    CONSTRAINT "DashboardWidgetUsuario_pkey" PRIMARY KEY ("id")
);
...
ALTER TABLE "TenantUser" ADD COLUMN "ultimoAcesso" TIMESTAMP(3);
...
ALTER TABLE "Unidade" ADD CONSTRAINT "Unidade_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "FuncionarioLotacao" ADD CONSTRAINT "FuncionarioLotacao_funcionarioId_fkey" FOREIGN KEY ("funcionarioId") REFERENCES "Funcionario"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "FuncionarioLotacao" ADD CONSTRAINT "FuncionarioLotacao_obraId_fkey" FOREIGN KEY ("obraId") REFERENCES "Obra"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "FuncionarioLotacao" ADD CONSTRAINT "FuncionarioLotacao_unidadeId_fkey" FOREIGN KEY ("unidadeId") REFERENCES "Unidade"("id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "OrganizacaoSetor" ADD CONSTRAINT "OrganizacaoSetor_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "OrganizacaoSetor" ADD CONSTRAINT "OrganizacaoSetor_setorPaiId_fkey" FOREIGN KEY ("setorPaiId") REFERENCES "OrganizacaoSetor"("id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "OrganizacaoCargo" ADD CONSTRAINT "OrganizacaoCargo_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "OrganogramaPosicao" ADD CONSTRAINT "OrganogramaPosicao_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "OrganogramaPosicao" ADD CONSTRAINT "OrganogramaPosicao_setorId_fkey" FOREIGN KEY ("setorId") REFERENCES "OrganizacaoSetor"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "OrganogramaPosicao" ADD CONSTRAINT "OrganogramaPosicao_cargoId_fkey" FOREIGN KEY ("cargoId") REFERENCES "OrganizacaoCargo"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "OrganogramaVinculo" ADD CONSTRAINT "OrganogramaVinculo_posicaoSuperiorId_fkey" FOREIGN KEY ("posicaoSuperiorId") REFERENCES "OrganogramaPosicao"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "OrganogramaVinculo" ADD CONSTRAINT "OrganogramaVinculo_posicaoSubordinadaId_fkey" FOREIGN KEY ("posicaoSubordinadaId") REFERENCES "OrganogramaPosicao"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "FuncionarioPosicao" ADD CONSTRAINT "FuncionarioPosicao_funcionarioId_fkey" FOREIGN KEY ("funcionarioId") REFERENCES "Funcionario"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "FuncionarioPosicao" ADD CONSTRAINT "FuncionarioPosicao_posicaoId_fkey" FOREIGN KEY ("posicaoId") REFERENCES "OrganogramaPosicao"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "EmpresaRepresentante" ADD CONSTRAINT "EmpresaRepresentante_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "EmpresaRepresentante" ADD CONSTRAINT "EmpresaRepresentante_funcionarioId_fkey" FOREIGN KEY ("funcionarioId") REFERENCES "Funcionario"("id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "EmpresaEncarregadoSistema" ADD CONSTRAINT "EmpresaEncarregadoSistema_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "EmpresaEncarregadoSistema" ADD CONSTRAINT "EmpresaEncarregadoSistema_funcionarioId_fkey" FOREIGN KEY ("funcionarioId") REFERENCES "Funcionario"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "EmpresaEncarregadoSistema" ADD CONSTRAINT "EmpresaEncarregadoSistema_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "EmpresaEncarregadoSistema" ADD CONSTRAINT "EmpresaEncarregadoSistema_definidoPorRepresentanteId_fkey" FOREIGN KEY ("definidoPorRepresentanteId") REFERENCES "EmpresaRepresentante"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "Perfil" ADD CONSTRAINT "Perfil_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "UsuarioPerfil" ADD CONSTRAINT "UsuarioPerfil_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "UsuarioAbrangencia" ADD CONSTRAINT "UsuarioAbrangencia_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "UsuarioAbrangencia" ADD CONSTRAINT "UsuarioAbrangencia_obraId_fkey" FOREIGN KEY ("obraId") REFERENCES "Obra"("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "UsuarioAbrangencia" ADD CONSTRAINT "UsuarioAbrangencia_unidadeId_fkey" FOREIGN KEY ("unidadeId") REFERENCES "Unidade"("id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "BackupPoliticaTenant" ADD CONSTRAINT "BackupPoliticaTenant_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "BackupPoliticaTenant" ADD CONSTRAINT "BackupPoliticaTenant_configuradoPorUserId_fkey" FOREIGN KEY ("configuradoPorUserId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "BackupExecucaoTenant" ADD CONSTRAINT "BackupExecucaoTenant_politicaId_fkey" FOREIGN KEY ("politicaId") REFERENCES "BackupPoliticaTenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "BackupExecucaoTenant" ADD CONSTRAINT "BackupExecucaoTenant_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "BackupRestauracaoTenant" ADD CONSTRAINT "BackupRestauracaoTenant_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "BackupRestauracaoTenant" ADD CONSTRAINT "BackupRestauracaoTenant_solicitadoPorUserId_fkey" FOREIGN KEY ("solicitadoPorUserId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "DashboardLayoutUsuario" ADD CONSTRAINT "DashboardLayoutUsuario_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "DashboardWidgetUsuario" ADD CONSTRAINT "DashboardWidgetUsuario_layoutId_fkey" FOREIGN KEY ("layoutId") REFERENCES "DashboardLayoutUsuario"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "AuditoriaEvento" ADD CONSTRAINT "AuditoriaEvento_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "AuditoriaEvento" ADD CONSTRAINT "AuditoriaEvento_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
