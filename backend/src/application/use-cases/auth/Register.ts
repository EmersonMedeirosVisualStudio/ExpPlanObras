...
import type { RegisterDto } from '@/application/dto/auth/registerDto.js'
import { generateUniqueTenantSlug } from '@/shared/utils/slug.js'
import { normalizeEmail, validateCEP, validateCNPJ, validateCPF, validateSlug } from '@/shared/utils/validators.js'
...
export class RegisterUseCase {
  async execute(input: RegisterDto) {
    ...
    try {
      ...
      if ((err as { code?: string })?.code === 'P2002') throw new UserAlreadyExistsError()
      throw err
    }
  }
}
