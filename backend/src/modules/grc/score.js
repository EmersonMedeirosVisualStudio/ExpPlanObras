const impactRank = { BAIXO: 1, MEDIO: 2, ALTO: 4, CRITICO: 5 };
const probRank = { RARO: 1, IMPROVAVEL: 2, POSSIVEL: 3, PROVAVEL: 4, QUASE_CERTO: 5 };
export function scoreFromImpactProbability(args) {
...
export function reduzirScorePorControles(args) {
