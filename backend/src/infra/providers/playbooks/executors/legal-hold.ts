import type { PlaybookActionExecutor } from '@/infra/providers/playbooks/types.js';
import { aplicarLegalHoldPorCriteria } from '@/infra/providers/retencao/legal-hold.js';
