import type { DashboardFilter, EventoFilter, FaturamentoFilter, IContratoRepository, ListContratosFilter } from '@/domain/repositories/IContratoRepository.js'
import {
...
} from '@/infra/providers/contratos/contratosOps.js'
