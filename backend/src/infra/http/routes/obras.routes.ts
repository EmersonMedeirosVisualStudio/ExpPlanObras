...
import { createObraDto } from '@/application/dto/obras/createObraDto.js'
import { updateObraDto } from '@/application/dto/obras/updateObraDto.js'
import { makeObraUseCases } from '@/application/contracts/makeObraUseCases.js'
import type { AbrangenciaContext } from '@/domain/entities/Obra.js'
import { lookupCep, normalizeCep, resolveCoords, searchGeocode } from '@/infra/providers/obras/GeocodingService.js'
