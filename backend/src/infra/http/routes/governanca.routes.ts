...
import { makeGovernancaDadosUseCases } from '@/application/contracts/makeGovernancaDadosUseCases.js'
import { sincronizarCatalogoBasico } from '@/infra/providers/governanca-dados/scanner.js'
import { executarScanPiiAmostral } from '@/infra/providers/governanca-dados/pii-scanner.js'
import { aceitarSugestaoClassificacao, rejeitarSugestaoClassificacao } from '@/infra/providers/governanca-dados/classificacao.js'
import { auditGovernanca } from '@/infra/providers/governanca-dados/audit.js'
import { calcularScoreQualidadePorAtivo } from '@/infra/providers/governanca-dados/quality.js'
import { AtivoNotFoundError, GovernancaForbiddenError, PiiScanNotFoundError, QualidadeRegraNotFoundError } from '@/domain/errors/GovernancaErrors.js'
