...
import { z } from 'zod'
import { makeGrcUseCases } from '@/application/contracts/makeGrcUseCases.js'
import { GrcForbiddenError, GrcUnauthorizedError } from '@/domain/errors/GrcErrors.js'
import { classificarScore, scoreFromImpactProbability } from '@/infra/providers/grc/score.js'
