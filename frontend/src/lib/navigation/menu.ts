  ...
  },
  {
    ...
    items: [
      { key: 'organograma', label: 'Organograma', href: '/dashboard/organograma', icon: 'network', permission: PERMISSIONS.ORGANOGRAMA_VIEW },
      {
        ...
        children: [
          {
            key: 'admin-licitacoes-dashboard',
            label: 'Dashboard',
          ...
          {
            key: 'admin-licitacoes-kanban',
            label: 'Quadro de Licitações (Kanban)',
          ...
          {
            key: 'admin-licitacoes-fases',
            label: 'Fases e Situação',
            href: '/dashboard/admin/licitacoes/fases',
            icon: 'route',
            permission: PERMISSIONS.DASHBOARD_ENGENHARIA_VIEW,
            scopeTypes: ['EMPRESA'],
          },
          {
            key: 'admin-licitacoes-exigencias',
          ...
          {
            key: 'admin-licitacoes-analise',
            label: 'Análise de Atendimento',
            href: '/dashboard/admin/licitacoes/analise-atendimento',
            icon: 'scan-search',
            permission: PERMISSIONS.DASHBOARD_ENGENHARIA_VIEW,
            scopeTypes: ['EMPRESA'],
          },
          {
            key: 'admin-licitacoes-acervo',
            label: 'Acervo Técnico da Empresa',
            href: '/dashboard/admin/licitacoes/acervo',
            icon: 'archive',
            permission: PERMISSIONS.DASHBOARD_ENGENHARIA_VIEW,
            scopeTypes: ['EMPRESA'],
          },
          {
            key: 'admin-licitacoes-documentos',
            label: 'Documentos',
            href: '/dashboard/admin/licitacoes/documentos',
            icon: 'paperclip',
            permission: PERMISSIONS.DASHBOARD_ENGENHARIA_VIEW,
            scopeTypes: ['EMPRESA'],
          },
          {
            key: 'admin-licitacoes-dossie',
            label: 'Dossiê da Licitação',
