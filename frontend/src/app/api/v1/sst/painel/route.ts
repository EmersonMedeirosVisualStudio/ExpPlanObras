...
export async function GET(_req: NextRequest) {
  try {
    ...
    const treinamentosVencidos: any[] = (
      await db.query(
        `
        SELECT
    ...
    const treinamentosVencidosPorMes: any[] = (
      await db.query(
        `
        SELECT
