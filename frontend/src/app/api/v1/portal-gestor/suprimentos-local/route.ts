...
import { assertPortalScopeHasLocal, obterSuprimentosLocalPortalGestor } from '@/lib/modules/portal-gestor/server';
...
export async function GET(req: Request) {
  try {
    ...
    const data = await obterSuprimentosLocalPortalGestor({ tenantId: current.tenantId, filtros });
    return ok(data);
  } catch (e) {
