...
import { assertPortalScopeHasLocal, obterAtalhosPortalGestor } from '@/lib/modules/portal-gestor/server';
...
export async function GET(req: Request) {
  try {
    ...
    const data = await obterAtalhosPortalGestor({ current, filtros });
    return ok(data);
  } catch (e) {
